...
# Restart aro11 Agent with new Studio SDP log configuration
# This script applies the updated configuration for monitoring Studio SDP Roulette logs

echo "🔄 Restarting aro11 Agent with new Studio SDP log configuration..."

# Change to telemetry directory
cd /home/rnd/telemetry

# Stop the current agent
echo "⏹️  Stopping current aro11 agent..."
...
echo "🚀 Starting aro11 agent with new configuration..."
...
docker compose -f docker-compose-GC-aro11-agent.yml logs --tail=20 promtail

echo ""
echo "✅ aro11 Agent restart completed!"
echo ""
echo "🔍 To test the configuration, run:"
echo "   python3 test_studio_sdp_logs.py"
echo ""
echo "📊 To monitor logs in real-time:"
echo "   docker compose -f docker-compose-GC-aro11-agent.yml logs -f promtail"
echo ""
echo "🌐 Access points:"
